 ...
 *  @author michelkramer
 */
public class AuthenticationModifyHandler extends AuthenticationRequestHandler {
     ...
     */
    public AuthenticationModifyHandler(ListeAuth la) {
        super(la);
    }
     ...
     */
    public AuthenticationModifyHandler(ListeAuth la, RequestHandler rq) {
        super(la, rq);
    }
     ...
     */
    public AuthenticationModifyHandler(AuthenticationRequestHandler rq) {
        super(rq);
    }
     ...
     */
    public AuthenticationModifyHandler() {
    }
    ...
    public Result process(AuthenticationRequest authenticationRequest){
        ...
        if(authenticationRequest.getType().equals("MOD")){
